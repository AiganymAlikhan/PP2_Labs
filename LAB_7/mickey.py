...
background = pygame.image.load("LAB_7/image/clock.png")
min_hand = pygame.image.load("LAB_7/image/min_hand.png")
sec_hand = pygame.image.load("LAB_7/image/sec_hand.png")
